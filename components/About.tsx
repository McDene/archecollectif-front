  ...
  return (
    <section className="bg-gradient-to-b from-myblue to-myblue py-20 md:py-36">
      <div className="max-w-6xl 2xl:max-w-7xl mx-auto flex flex-col text-gray-800 px-4">
        {/* Titre principal */}
        <h1 className="text-myred text-6xl sm:text-6xl lg:text-9xl font-avenirBlack pb-12 md:pb-24 text-justify md:text-left">
        ...
        <div className="flex flex-col md:flex-row gap-12 lg:gap-40">
          ...
          <div className="text-center md:text-left">
            <p className="text-3xl text-justify">{textAbout}</p>
          </div>
        </div>
      </div>
    </section>
