  ...
  return (
    <section className="bg-myblue py-20 md:py-28 lg:h-lvh">
      <div className="max-w-7xl mx-auto flex flex-col text-gray-800 px-4">
        {/* Titre principal */}
        <h1 className="text-5xl sm:text-6xl lg:text-9xl font-avenirBlack pb-12 md:pb-24 text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row gap-12 lg:gap-40">
          ...
          <div className="space-y-4 md:space-y-5 text-center md:text-left">
            <h2 className="text-3xl sm:text-4xl lg:text-6xl font-avenirBlack text-myred underline">
              Humain
            </h2>
            <h2 className="text-3xl sm:text-4xl lg:text-6xl font-avenirBlack text-myred underline">
              Optimiste
